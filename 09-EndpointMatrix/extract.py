...
def boxplot(data, pos, outliers_lower=5, outliers_upper=10):
    ...
    return (
        ...
        f"boxplot/draw position={pos}, mark=+, every mark/.append style={{mark size=1pt, line width=0.2pt}}] table\n"
...
if __name__ == "__main__":
    ...
    for endpoint in [
        ...
        data = parse_e2e_file(args.input_path, f"?-*{endpoint}*.i100.x10240.csv")
        text = boxplot(data, position, outliers_lower=10, outliers_upper=30)
        print(text)
